...
public class DownloadInfo {
	...
	/** * @param url 下载地址url * @param splitter 分成多少段或是多少个线程下载 */
	public DownloadInfo(String url, int splitter) {
		this(url, null, null, splitter);
	}

	/***
	 * * @param url 下载地址 * @param fileName 文件名称 * @param filePath 文件保存路径 * @param
	 * splitter 分成多少段或是多少个线程下载
	 */
	...
	/**
	 * * <b>function:</b> 通过url获得文件名称 * @author hoojo * @createDate 2011-9-30
	 * 下午05:00:00 * @param url * @return
	 */
